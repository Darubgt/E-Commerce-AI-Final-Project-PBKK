...
<body style="margin: 0 auto;">
    ...
    <main class="w-4/5 mx-auto">
      <div class="container min-h-screen">
        ...
        @if (count($produk))
          @foreach ($produk as $p)
          <a href="{{ route ('product.page', $p->id_produk)}}" style="width: 250px; height: 320px;" class="my-4 no-underline border rounded hover:scale-105 hover:-translate-y-1 ease-linear duration-300 shadow-lg hover:shadow-2xl">
